...
export function CompanyForm({ company }: { company?: Company }) {
  ...
  const form = useForm<CompanyFormInput, unknown, CompanyFormValues>({
    ...
    defaultValues: {
      ...
      detail: {
        tagline: company?.detail?.tagline ?? "",
        salesEmail: company?.detail?.salesEmail ?? "",
        contactPhone: company?.detail?.contactPhone ?? "",
        minProjectSize: company?.detail?.minProjectSize ?? "",
        reviews: company?.detail?.reviews ?? "",
        agencyStatus: company?.detail?.agencyStatus ?? "",
        utmSourceEnable: company?.detail?.utmSourceEnable ?? false,
      },
    },
  });
          ...
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Dialog>
              ...
              <DialogContent className="max-w-md">
                <DialogHeader>
                  <DialogTitle>Metadata Fields</DialogTitle>
                </DialogHeader>
                <div className="space-y-4 py-4">
                  ...
                  <FormField
                    control={form.control}
                    name="detail.minProjectSize"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Min Project Size</FormLabel>
                        <FormControl>
                          <Input {...field} value={field.value ?? ""} />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    control={form.control}
                    name="detail.agencyStatus"
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Agency Status</FormLabel>
                        <FormControl>
                          <Input {...field} value={field.value ?? ""} />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    control={form.control}
                    name="detail.utmSourceEnable"
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                        <FormLabel className="!mt-0">UTM Source Enable</FormLabel>
                        <FormControl>
