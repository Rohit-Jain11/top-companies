...
import { useBlogCategoryQuery } from "@/lib/queries/blog-categories";

export default function EditBlogCategoryPage() {
  const params = useParams<{ id: string }>();
  const { data: category, isLoading } = useBlogCategoryQuery(Number(params.id));

  return (
    <div className="max-w-3xl space-y-4">
      <div>
        <h1 className="text-2xl font-semibold">Edit Blog Category</h1>
