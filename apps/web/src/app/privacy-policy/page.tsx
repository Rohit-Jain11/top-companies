                ...
                <div className="container-8xl">
                    <div className="max-w-180 mx-auto">
                        <div className='flex flex-wrap items-center justify-center gap-1.5'>
                            ...
                            <span className='text-sm leading-6 text-foreground block uppercase font-medium'>Privacy Policy</span>
                        </div>
                        <h1 className='font-fraunces text-foreground text-[32px] xl:text-[54px] leading-10 xl:leading-14.25 tracking-[-1.62px] font-normal my-2 xl:my-7.5 text-center'>Your Privacy, <span className="text-primary font-light italic">Our Commitment</span></h1>
