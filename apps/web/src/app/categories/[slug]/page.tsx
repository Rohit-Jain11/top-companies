      ...
      <div className="container-8xl">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 xl:gap-7.5 xl:px-7">
          <div className="rounded-2xl py-3.5 px-4 xl:px-7 flex items-center gap-x-5 gap-y-2 bg-white shadow-card flex-col sm:flex-row text-center sm:text-left">
            <span className="font-fraunces text-[28px] xl:text-[42px] leading-9 xl:leading-16.25 tracking-[-1.26px] text-primary shrink-0">335</span>
            <p className="text-lg leading-7 text-secondary">Companies <br />Ranked</p>
          </div>
          <div className="rounded-2xl py-3.5 px-4 xl:px-7 flex items-center gap-x-5 gap-y-2 bg-white shadow-card flex-col sm:flex-row text-center sm:text-left">
            <span className="font-fraunces text-[28px] xl:text-[42px] leading-9 xl:leading-16.25 tracking-[-1.26px] text-primary shrink-0">10+</span>
            <p className="text-lg leading-7 text-secondary">Countries <br />Covered</p>
          </div>
          <div className="rounded-2xl py-3.5 px-4 xl:px-7 flex items-center gap-x-5 gap-y-2 bg-white shadow-card flex-col sm:flex-row text-center sm:text-left">
            <span className="font-fraunces text-[28px] xl:text-[42px] leading-9 xl:leading-16.25 tracking-[-1.26px] text-primary shrink-0 inline-flex gap-1.5 items-baseline">2h <span className="text-[30px] leading-8">ago</span></span>
            <p className="text-lg leading-7 text-secondary">Last <br />Updated</p>
          </div>
          <div className="rounded-2xl py-3.5 px-4 xl:px-7 flex items-center gap-x-5 gap-y-2 bg-white shadow-card flex-col sm:flex-row text-center sm:text-left">
            <span className="font-fraunces text-[28px] xl:text-[42px] leading-9 xl:leading-16.25 tracking-[-1.26px] text-primary shrink-0">9.4</span>
