...
export default function BlogContent({
    ...
    const totalPages =
        blogsData?.blogs?.meta?.totalPages ?? 1;
            ...
            <div className='text-center mb-8 xl:mb-15'>
                ...
                <ul className='flex items-center border border-border rounded-2xl p-2.5 max-w-fit mx-auto overflow-x-auto bg-white'>
                    ...
                    <li
                        className={`relative ${
                            categories?.length
                                ? 'after:content-[""] after:absolute after:top-1/2 after:right-0 after:-translate-y-1/2 after:w-0.5 after:h-8 after:bg-border'
                                : ''
                        }`}
                    >
                        ...
                        <Link
                            href="/blog"
                            className={`text-base leading-5.5 min-w-27.5 lg:min-w-38 px-2.5 lg:px-4 py-2.5 rounded-2xl inline-block ${
                            ...
                            blogs.map((blog: any) => (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className='text-lg leading-7 text-secondary mt-4 xl:mt-6 mb-4 xl:mb-7.5'>
                                            {blog.content}
                                        </p>

                                        <Link
                                            href={`/blog/${blog.slug}`}
                                            className='text-lg leading-7 font-semibold text-foreground py-2.75 px-6.5 inline-block border border-foreground rounded-full bg-white transition-all ease-in-out duration-300 hover:bg-primary hover:border-primary hover:text-white'
                                        >
                                            Read more
                                        </Link>
                        ...
                        <ul className='flex flex-wrap justify-center gap-3.5 mt-8 xl:mt-15'>
                            ...
                            <li>
                                ...
                                <button
                                    ...
                                    className={`w-13 h-13 border border-border rounded-full flex items-center justify-center ${
                                        page === 1
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className={`w-13 h-13 border rounded-full flex items-center justify-center ${
                                                    page ===
                                                    pageNumber
                ...
                <div className='lg:basis-[calc(35%-24px)] xl:basis-[calc(33.9%-60px)] max-w-full w-full lg:max-w-[calc(35%-24px)] xl:max-w-[calc(33.9%-60px)] shrink-0 mt-10 lg:mt-0'>
                    ...
                    >
                        ...
                        <div className='relative'>
                            ...
                            <button
                                type='submit'
                                className='w-13.5 h-13.5 flex items-center justify-center absolute top-0 right-1'
                    ...
                    <div className='mt-6 xl:mt-10'>
                        ...
                        <h2 className='text-foreground text-[22px] xl:text-[28px] leading-7 xl:leading-11 tracking-[-0.56px] font-fraunces mb-4 xl:mb-6'>
                            Recent Post
                        </h2>
                        ...
                        <div className='space-y-4 xl:space-y-5'>
                            ...
                            {filteredRecentPosts.length > 0 ? (
                                filteredRecentPosts.map(
                                    (post: any) => (
                                        <Link
                                            href={`/blog/${post.slug}`}
                                            key={post.id}
                                            className='rounded-[20px] p-2.5 blogGlass flex flex-wrap gap-4'
                                        >
