      ...
      <div className="container-8xl">
        ...
        <div className="border-t border-t-secondary pt-6 pb-7.5 flex flex-wrap flex-col md:flex-row items-center justify-between gap-2">
          ...
          <div className="flex flex-wrap items-center text-border gap-1">
            <Link href={"#"} title="Privacy" className="text-border text-xs leading-4 font-normal hover:text-primary transition-all ease-in-out duration-200">Privacy</Link>
            <span className="inline-block leading-4">·</span>
            <Link href={"#"} title="Terms" className="text-border text-xs leading-4 font-normal hover:text-primary transition-all ease-in-out duration-200">Terms</Link>
          </div>
        </div>
      </div>
    </footer>
